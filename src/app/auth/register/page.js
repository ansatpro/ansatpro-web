  ...
  function isSequential(str) {
    ...
    for (const seq of sequences) {
      for (let i = 0; i <= seq.length - 4; i++) {
        ...
        if (str.toLowerCase().includes([...sub].reverse().join("")))
          return true;
      }
    }
    return false;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your account has been created but not verified yet",
        duration: 3000,
      });
          ...
          <CardContent className="p-6">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  I declare that I am a registered nurse, holding current
                  nursing registration with Nursing and Midwifery Board of
                  Australia (NMBA).
                </label>
              </div>
