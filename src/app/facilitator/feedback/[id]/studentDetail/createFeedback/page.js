...
export default function ReviewFeedback() {
  ...
  const handleSubmit = async () => {
    ...
    if (discussedWithStudent === "yes" && !discussionDate) {
      alert("Please select the discussion date with the student");
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <span className="ml-1">Back to Student Details</span>
        </Button>
      </div>
      ...
      <header className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Rate the student's feedback and provide your assessment
        </p>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">
                {feedbackData.date ? format(new Date(feedbackData.date), "yyyy-MM-dd HH:mm") : "N/A"}
              </p>
            </div>
            <div>
