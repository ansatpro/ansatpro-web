        ...
        <Card className="bg-card">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <Button asChild className="h-auto p-6 bg-background hover:bg-muted border" variant="outline">
                <Link href="/facilitator/student/studentRegister">
                  <div className="flex flex-col items-center gap-2 w-full">
                    <span className="text-lg font-semibold text-foreground break-words whitespace-normal text-center">Register Student</span>
              ...
              <Button asChild className="h-auto p-6 bg-background hover:bg-muted border" variant="outline">
                <Link href="/facilitator/feedback">
                  <div className="flex flex-col items-center gap-2 w-full">
                    <span className="text-lg font-semibold text-foreground break-words whitespace-normal text-center">Review Feedback</span>
                    <p className="text-center text-sm text-muted-foreground line-clamp-3 overflow-hidden">
              ...
              <Button asChild className="h-auto p-6 bg-background hover:bg-muted border" variant="outline">
                <Link href="/facilitator/export">
                  <div className="flex flex-col items-center gap-2 w-full">
                    <span className="text-lg font-semibold text-foreground break-words whitespace-normal text-center">Export Report</span>
                    <p className="text-center text-sm text-muted-foreground line-clamp-3 overflow-hidden">
