...
describe('ANSAT Pro E2E Tests', () => {
  test('Home page loads correctly', async () => {
    ...
    const logoElement = await driver.findElement(By.css('img[alt="ANSAT Pro"]'));
  ...
  test('Notifications can be accessed', async () => {
    ...
    const notificationBtn = await driver.findElement(By.css('button[aria-label="Notifications"]'));
    ...
    const pageTitle = await driver.findElement(By.xpath('//h1[contains(text(), "Notifications")]'));
  ...
  test('Student registration form validation', async () => {
    ...
    const errorMessagesAfter = await driver.findElements(By.css('.text-red-500'));
  ...
  test('Logout functionality', async () => {
    ...
    const logoutBtn = await driver.findElement(By.xpath('//button[contains(text(), "Log out")]'));
