...
export default async ({ req, res, log, error }) => {
  ...
  function createAIPrompt(feedbackData) {
    ...
    Provide the summary with bullet points for each section. The AI should focus on the key themes from the feedback and generate the sections in a natural, helpful way. Do not include any specific scores, only focus on key themes from the content and review comments.
  `;
  }
