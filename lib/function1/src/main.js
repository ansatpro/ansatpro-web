   ...
   if (req.path === "/facilitator/get/studentsWithAllDetails") {
    switch (req.method) {
      case "GET":
        ...
        // // First, make a map of studentID => feedbacks[]
        // const feedbackMap = {};

        // // Group feedbacks by student_document_id
        // for (const feedback of allFeedbackDocuments) {
        ...
        // // Now, merge each student with their feedbacks
        // const studentsWithFeedback = allDocuments_students.map(student => {
        //   return {
        //     ...student,
        //     preceptorFeedbackList: feedbackMap[student.$id] || [] // default to empty if none
        //   };
        // });

        // log(studentsWithFeedback)




        return res.json(allFeedbackItems);
